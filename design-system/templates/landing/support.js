  ...
  function createComponentFactory(registry, ensureFetched) {
    ...
    class StreamableComponent extends React.Component {
      constructor(props) {
        ...
        /** When a localworker throws, remember the (class, registry.ver, props)
         ...
         *  so one instance's successful localworker can't hide a sibling's failure,
         *  and a localworker can never wipe an eval error `updateJs` recorded on
         *  `r.logicError`. */
